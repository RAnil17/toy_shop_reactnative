...
export default function CartScreen({ navigation }: Props) {
  ...
  const renderEmptyCart = () => (
    <View style={styles.emptyContainer}>
      ...
      >
        <Icon name="shopping" size={20} color={theme.colors.text.white} style={{ marginRight: 8 }} />
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.checkoutSection}>
        ...
        >
          <Icon name="credit-card-outline" size={20} color={theme.colors.text.white} style={{ marginRight: 8 }} />
